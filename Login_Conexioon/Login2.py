...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.usuario_texto.setGeometry(QtCore.QRect(20, 20, 51, 16))
        font = QtGui.QFont()
        ...
        self.usuario_texto.setStyleSheet("color: rgb(0, 0, 0);\n"
        "background-color: rgb(170, 255, 127);")
        self.usuario_texto.setObjectName("usuario_texto")
        self.pass_texto = QtWidgets.QLabel(self.centralwidget)
        self.pass_texto.setGeometry(QtCore.QRect(20, 50, 47, 13))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(10)
        self.pass_texto.setFont(font)
        self.pass_texto.setStyleSheet("color: rgb(0, 255, 0);\n"
        "color: rgb(0, 0, 0);\n"
